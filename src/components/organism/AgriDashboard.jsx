        ...
        const fetchData = async () => {
            try {
                const response = await fetch(
                    `/api/fruitAndVegetable/pricesSupplyChain?memberStateCodes=ES&beginDate=${formatDate(filters.beginDate)}&endDate=${formatDate(filters.endDate)}`
                )
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[10px] ml-2 mb-1 font-bold opacity-50 uppercase">
                            Desde
                        </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div
                        className="md:col-span-3 rounded-[2rem] p-8 shadow-sm relative"
                        style={{ backgroundColor: colors.cardBg }}
                    >
                        <div className="flex justify-between items-center mb-8">
                            <h2 className="text-2xl font-bold opacity-80 text-[#3a6351]">
                                Evolución Precios (€)
                            </h2>
                    ...
                    <div
                        className="rounded-[2rem] p-8 text-white flex flex-col justify-between shadow-lg"
                    ...
                    <div
                        className="md:col-span-2 rounded-[2rem] p-8 shadow-sm"
                        style={{ backgroundColor: colors.cardBg }}
                    >
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="truncate w-40 md:w-64">
                                                {v.replace("Apples - ", "")}
                                            </span>
                                        </div>
                    ...
                    <div
                        className="md:col-span-2 rounded-[2rem] p-8 shadow-sm flex flex-col justify-between"
                        style={{ backgroundColor: colors.cardBg }}
                    >
                        <div>
                            <h3 className="font-bold mb-2 opacity-70 text-lg">
                                Perspectiva
                            </h3>
                            ...
                            <p className="text-sm opacity-60 leading-relaxed">
                                ...
                                {variation}% respecto al inicio del periodo.
